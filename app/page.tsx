...
const SAMPLE_DEALS: Deal[] = [
  {
    ...
    category: "Computing",
    imageUrl: "/modern-graphics-card.png",
  ...
  },
  {
    ...
    category: "Computing",
    imageUrl: "/placeholder-53197.png",
    uploader: "ace310",
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="flex space-x-1 mb-6">
          ...
          <Button variant={sortBy === "new" ? "outline" : "ghost"} onClick={() => setSortBy("new")}>
            new
          </Button>
        </div>
              ...
              <div className="flex space-x-4">
                ...
                <div className="flex flex-col items-center space-y-1 min-w-[60px]">
                  <Button
                    ...
                    className={`p-1 ${deal.userVote === "up" ? "text-green-600 bg-green-50" : "text-gray-400 hover:text-green-600"}`}
                  >
                  ...
                  <Button
                    ...
                    className={`p-1 ${deal.userVote === "down" ? "text-red-600 bg-red-50" : "text-gray-400 hover:text-red-600"}`}
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center space-x-4 text-sm text-gray-500 mb-3">
                        ...
                        <div className="flex items-center space-x-1">
                          ...
                          <span>{format(new Date(deal.createdAt), "dd/MM/yyyy - HH:mm")}</span>
                        </div>
                        <div className="flex items-center space-x-1">
